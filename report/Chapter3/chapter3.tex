...
These capabilities arrived as new contexts and projections, not as edits to the four
...
regenerated artefact that a build step keeps in sync across both.
...
single logical event store is partitioned by that context. The framework already reaches further than
