...
Mots-clés : gestion du cycle de vie des contrats, CQRS, Event Sourcing, piste d’audit.

## ملخص
تدير الشركات المتوسطة في DACH عقودها يدويًا، فتفوت مواعيد التجديد ولا تترك الموافقات أثرًا قابلًا للتدقيق، بينما تشترط GoBD واللائحة الأوروبية لحماية البيانات ومعيار ISO 27001 سجلات غير قابلة للتعديل ومنسوبة. وCLMPilot منصة لإدارة دورة حياة العقود قائمة على أولوية الدمج، تدير البيانات الوصفية والآجال والموافقات وسجل التدقيق مع بقاء الوثيقة لدى العميل، وتعتمد على comby، وهو إطار داخلي بلغة Go يطبق CQRS ومصادر الأحداث، فيغدو سجل التدقيق خاصية أصيلة في النظام.
الكلمات المفتاحية: إدارة دورة حياة العقود، CQRS، Event Sourcing، سجل التدقيق.
